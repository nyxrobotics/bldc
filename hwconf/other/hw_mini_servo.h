...
#ifndef HW_MINI_SERVO_H_
#define HW_MINI_SERVO_H_

#define HW_NAME "MINI_SERVO"
...
#define NTC_TEMP_MOTOR(beta)                                                                                           \
  (1.0 / ((logf(NTC_RES_MOTOR(ADC_Value[ADC_IND_TEMP_MOTOR]) / 10000.0) / beta) + (1.0 / 298.15)) - 273.15)
